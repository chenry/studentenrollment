...
public class StudentEnrollmentService {
  ...
  private boolean hasStudentCompletedCoursePrerequisites(Student student, Course course) {
    ...
    Set<Long> studentCompletedCourseIds = enrollmentService.findCompletedCoursesByStudentId(student.getId());
  ...
  private boolean isCourseFull(Course persistedCourse) {
    List<Enrollment> enrollmentList = enrollmentService.findEnrollmentsByCourseId(persistedCourse.getId());
